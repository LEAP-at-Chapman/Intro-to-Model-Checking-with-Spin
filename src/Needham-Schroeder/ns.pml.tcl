...
.c create rectangle 110 0 174 20 -fill black
# ProcLine[1] stays at 0 (Used 0 nobox 0)
.c create rectangle 108 -2 172 18 -fill ivory
.c create text 140 8 -text "0:ltl_0"
...
.c create rectangle 114 46 486 66 -fill white -width 0
.c create text 300 56 -text "network!msg1,intruder,keyI,alice,nonceA"
...
.c create rectangle 434 70 806 90 -fill white -width 0
.c create text 620 80 -text "network?msg1,intruder,keyI,alice,nonceA"
...
.c create rectangle 458 94 782 114 -fill white -width 0
.c create text 620 104 -text "network!msg1,bob,keyB,alice,nonceA"
...
.c create rectangle 298 118 622 138 -fill white -width 0
.c create text 460 128 -text "network?msg1,bob,keyB,alice,nonceA"
...
.c create rectangle 284 142 636 162 -fill white -width 0
.c create text 460 152 -text "network!msg2,alice,keyA,nonceA,nonceB"
...
.c create rectangle 444 166 796 186 -fill white -width 0
.c create text 620 176 -text "network?msg2,alice,keyA,nonceA,nonceB"
...
.c create rectangle 444 190 796 210 -fill white -width 0
.c create text 620 200 -text "network!msg2,alice,keyA,nonceA,nonceB"
...
.c create rectangle 124 214 476 234 -fill white -width 0
.c create text 300 224 -text "network?msg2,alice,keyA,nonceA,nonceB"
...
.c create rectangle 132 238 468 258 -fill white -width 0
.c create text 300 248 -text "network!msg3,intruder,keyI,nonceB,0"
...
.c create rectangle 452 262 788 282 -fill white -width 0
.c create text 620 272 -text "network?msg3,intruder,keyI,nonceB,0"
...
.c create rectangle 452 286 788 306 -fill white -width 0
.c create text 620 296 -text "network!msg3,bob,keyB,nonceB,nonceA"
...
.c create rectangle 292 310 628 330 -fill white -width 0
.c create text 460 320 -text "network?msg3,bob,keyB,nonceB,nonceA"
