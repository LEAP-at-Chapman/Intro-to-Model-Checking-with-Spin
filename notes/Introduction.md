...
[^1]: As usual, $\mathbb{N}=\\{0,1,2\ldots\\}$ denotes the set of natural numbers; $(v\_n)\_{n\in\mathbb{N}}$, or $(v\_n)$, is short for $(v\_0,v\_1,v\_2\ldots)$. Each $v\_n$ represents a state of the computation. Think of it as the memory and of $v\_n(p)$ as the value of bit $p$ at time $n$.
