...
typedef Crypt { /* the encrypted part of a message */
  mtype key, d1, d2, d3;
/*corrected*/
/*added a third field to encrypted message; it is used to store the identity of the sender in message 2; to find the modified code search for .d3 */
}
...
active proctype Alice() { /* honest initiator for one protocol run */
  ...
  (data.key == keyA) && (data.d1 == nonceA) && (data.d3 == partnerA);
  ...
  */
  ...
  :: /* Replay or send a message */
     ...
     :: atomic {
	  ...
	  :: data.d2 = nonceI;
	  if /* assemble message; note: most combinations are rubbish */
	  :: msg == msg2 --> data.d3 = alice;
	  :: msg == msg2 --> data.d3 = bob;
	  :: msg == msg2 --> data.d3 = intruder;
	  fi;
	  fi;
        }
